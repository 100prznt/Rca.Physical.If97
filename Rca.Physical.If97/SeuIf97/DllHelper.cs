...
namespace Rca.Physical.If97.SeuIf97
{
    ...
    public class DllHelper
    {
        ...
        public static void ExtractEmbeddedDlls(string dllName, byte[] resourceBytes)
        {
            ...
            m_TempFolder = String.Format("{0}.{1}.{2}", an.Name, an.ProcessorArchitecture, an.Version);

            string dirName = Path.Combine(Path.GetTempPath(), m_TempFolder);
        ...
        static public void LoadDll(string dllName)
        {
            ...
            if (h == IntPtr.Zero)
            {
                ...
                throw new DllNotFoundException("Unable to load library: " + dllName + " from " + m_TempFolder, e);
            }
        }
